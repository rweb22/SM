...
public class betting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerview.setLayoutManager(new GridLayoutManager(betting.this, 2));
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    if (getSharedPreferences(constant.prefs,MODE_PRIVATE).getString("is_gateway","0").equals("1")){
                                        startActivity(new Intent(betting.this, wallet.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
                                    } else {
                                        openWhatsApp();
                                    }
                                    dialog.dismiss();
