...
public class constant {
    ...
    // API FOLDER URL
    static String prefix = "https://kalyan.samrat-satta.com/";
    static String prefix2 = "https://kalyan.samrat-satta.com/";
    ...
    static String link = "https://kalyan.samrat-satta.com/admin/static/download/samrat.apk";

    // PROJECT ROOT URL
    static String project_root = "https://kalyan.samrat-satta.com/";

    // PROJECT ROOT URL
    static String admin_root = "https://kalyan.samrat-satta.com/admin/";
