...
public class constant {
    ...
    // API FOLDER URL
    static String prefix = "https://samrat777.site/";
    static String prefix2 = "https://samrat777.site/";

    // APK DOWNLOAD LINK0938
    static String link = "https://samrat777.site/admin/static/download/samrat.apk";

    // PROJECT ROOT URL
    static String project_root = "https://samrat777.site/";
