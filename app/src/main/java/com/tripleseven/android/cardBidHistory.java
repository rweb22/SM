...
public class cardBidHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = constant.prefix + "card_games.php";
        url2 = constant.prefix + "get_card_markets.php";
    ...
    private void get_market() {
        ...
        progressDialog = new ViewDialog(cardBidHistory.this);
        ...
        final StringRequest postRequest = new MyStringRequest(getSharedPreferences(constant.prefs, MODE_PRIVATE), Request.Method.POST, url2,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>
                                    (cardBidHistory.this, R.layout.simple_list_item_3,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressDialog.hideDialog();
                        Toast.makeText(cardBidHistory.this, "Check your internet connection", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
