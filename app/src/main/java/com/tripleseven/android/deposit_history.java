...
//        balance.setText(getSharedPreferences(constant.prefs, MODE_PRIVATE).getString("wallet", "0"));
        url = constant.prefix + "deposit_history.php";
    ...
    private void apicall() {
        ...
        progressDialog = new ViewDialog(deposit_history.this);
        ...
        final StringRequest postRequest = new MyStringRequest(getSharedPreferences(constant.prefs, MODE_PRIVATE), Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressDialog.hideDialog();
                        Toast.makeText(deposit_history.this, "Check your internet connection", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
