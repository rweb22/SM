...
class adapter_transaction_funds extends RecyclerView.Adapter<adapter_transaction_funds.ViewHolder> {
    ...
    public adapter_transaction_funds(Context context, ArrayList<String> date, ArrayList<String> remark, ArrayList<String> amount, ArrayList<String> type) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.transaction_item_sx, parent, false);
